...
public class AngularPracticeTest extends Base {
    public WebDriver driver;
    private HomePage homePage;
    private AcademyMainPage academyMainPage;
    private PracticeLoginPage practiceLoginPage;
    private PracticePage practicePage;
    private AngularPracticePage angularPracticePage;
    private WebDriverWait explicitWait;

    private static Logger logs = LogManager.getLogger(AngularPracticeTest.class.getName());
    @BeforeTest
    public void initDriverAndNavigateToPracticePage() throws IOException {
        ...
        angularPracticePage = practicePage.clickAutomationPractice3Button();
    }
